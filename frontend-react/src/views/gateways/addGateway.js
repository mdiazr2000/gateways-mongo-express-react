...
import {getAddGatewaysEndpoint, API_ENDPOINT, getGatewaysEndpoint} from "../../core/api/endpoints";
...
export default function AddGateway() {
    ...
    const addGateway = async () => {
        ...
        const url = getAddGatewaysEndpoint();
                ...
                <div className="form-container" style={{paddingTop:'30px'}}>
                    <div className="form-sub-container">
                        ...
                        <div className="form-header">
                            <div className="form-title"><h3>Add Gateway</h3></div>
                            ...
                            <form>
                                ...
                                <div className="form-button">
                                    <button style={{width: '300px'}} onClick={addGateway}
